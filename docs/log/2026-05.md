# Archived ledger — 2026-05

> **Provenance:** This monthly archive preserves the full 2026-05 operational history under
> Axiom 3 (*Preserve Every Attempt*), newest-first across two schema generations. On top: the
> **canonical-schema** entries (`iter-0076`–`iter-0100`), rotated out of `docs/LOG.md` at
> iter-0101 when the active ledger reached the 1,000-line cap. Below: the **legacy** `LOOP_LOG.md`
> entries (Iterations 1–75), moved here intact at iter-0076 — the 2026-05-24 substrate refresh
> (`1159d45`) installed the canonical `docs/LOG.md` schema and forbade a separate `LOOP_LOG.md`.
> This file is read-only history; **new entries live in `docs/LOG.md`** (legacy
> `## YYYY-MM-DD — Iteration N` schema appears in the lower section).

---

## Canonical-schema entries — iter-0076 … iter-0100 (rotated from docs/LOG.md at iter-0101)
